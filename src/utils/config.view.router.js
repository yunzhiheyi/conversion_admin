export default {
  ...
  'category/:name': () => import('@/views/category'), // 新闻分类
  'product/info/:name': () => import('@/views/product/goods/info'), // 商品添加\删除
  'product/specification': () => import('@/views/product/goods/spec'), // 规格管理
  'order/list': () => import('@/views/order/list'), // 订单列表
  'product': () => import('@/views/product/goods/list'), // 商品列表
  'user': () => import('@/views/user/list'), // 用户列表
  'system/parameters': () => import('@/views/system/parameters'), // 系统参数
  'marketing/advertising': () => import('@/views/marketing/advertising'), // 广告管理
  'article': () => import('@/views/news/article/list'), // 新闻列表
  'project': () => import('@/views/project'), // 专题列表
  'message': () => import('@/views/message'), // 留言列表
  'article/info/:name': () => import('@/views/news/article/info'), // 新闻添加/编辑
